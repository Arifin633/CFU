...
namespace CFU.Tiles
{
    ...
    {
        public override string Texture => "CFU/Textures/Tiles/Stations/Hellsmith";
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Hellsmith>());
        }
    }
}
