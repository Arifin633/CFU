...
namespace CFU.Tiles
{
    public class StoneFrieze : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.StoneFrieze>());
            return true;
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(
                ModContent.Request<Texture2D>("CFU/Textures/Tiles/Blocks/StoneFrieze").Value,
