...
namespace CFU.Tiles
{
    public class MiracleFlowerVine : ModTile
    {
        public override string Texture => "CFU/Textures/Tiles/Miracle Plants/Vines/MiracleFlowerVine";
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.MiracleFlowerVine>());
            return true;
        }
