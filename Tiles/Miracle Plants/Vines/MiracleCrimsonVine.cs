...
namespace CFU.Tiles
{
    public class MiracleCrimsonVine : ModTile
    {
        public override string Texture => "CFU/Textures/Tiles/Miracle Plants/Vines/MiracleCrimsonVine";
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.MiracleCrimsonVine>());
            return true;
        }
