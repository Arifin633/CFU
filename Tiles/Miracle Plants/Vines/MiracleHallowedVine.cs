...
namespace CFU.Tiles
{
    public class MiracleHallowedVine : ModTile
    {
        public override string Texture => "CFU/Textures/Tiles/Miracle Plants/Vines/MiracleHallowedVine";
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.MiracleHallowedVine>());
            return true;
        }
