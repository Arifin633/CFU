...
namespace CFU.Items
{
    public class BagGrass : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Miracle Plants/Bags/BagGrass";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Magic Seed Bag (Grass)");
