...
namespace CFU.Items
{
    public class MiracleLilyPad : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Miracle Plants/Lily Pads/MiracleLilyPad";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Miracle Lily Pad Seeds");
