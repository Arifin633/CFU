...
namespace CFU.Items
{
    public class MiracleMushroom : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Miracle Plants/Short Plants/MiracleMushroom";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Miracle Mushroom");
