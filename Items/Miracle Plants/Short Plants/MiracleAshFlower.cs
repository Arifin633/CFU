...
namespace CFU.Items
{
    public class MiracleAshFlower : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Miracle Plants/Short Plants/MiracleAshFlower";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Miracle Ash Grass Flower Seeds");
