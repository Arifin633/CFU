...
namespace CFU.Items
{
    public class BagSeaweed : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Magic Seed Bags/BagSeaweed";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Magic Seed Bag (Seaweed)");
