...
namespace CFU.Items
{
    public class StrangePlantRed : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Garden/Plants/StrangePlantRed";
        ...
        {
            CreateRecipe()
            .AddIngredient(ItemID.StrangePlant4, 1)
