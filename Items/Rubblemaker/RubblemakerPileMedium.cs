...
namespace CFU.Items
{
    public class RubblemakerPileMedium : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Rubblemaker/RubblemakerPileMedium";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Rubblemaker 2.0 (Medium Piles)");
        ...
        public override void SetDefaults()
        {
            ...
            Item.maxStack = 1;
            Item.useTurn = true;
            Item.createTile = TileID.LargePilesEcho;
            Item.autoReuse = true;
        ...
        {
            this.Item.SetDefaults(ModContent.ItemType<Items.RubblemakerPileLarge>());
            this.Item.stack = 1;
        }
        ...
        public override void PostDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            spriteBatch.Draw(ModContent.Request<Texture2D>("CFU/Textures/Items/Rubblemaker/RubblemakerBar").Value,
                             position + offset, new Rectangle(40, 0, 8, 20), drawColor, 0f, default, 1f, SpriteEffects.None, 0f);
        }
    }
}
