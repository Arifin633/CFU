...
namespace CFU.Items
{
    public class RubblemakerStalactiteMedium : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Rubblemaker/RubblemakerStalactiteMedium";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Rubblemaker 2.0 (Stalactites & Stalagmites)");
