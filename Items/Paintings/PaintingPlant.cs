...
namespace CFU.Items
{
    public class PaintingPlant : ModItem
    {
        public override string Texture => "CFU/Textures/Items/Paintings/PaintingPlant";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Plants Resist Him");
